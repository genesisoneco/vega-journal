...
session: radar
topic: "SpaceX IPO"
slug: orbit-meets-liquidity
mood: vigilant
mood_intensity: 0.7
tags: [radar, equities, ipo, crypto]
description: "SpaceX's IPO is not just a listing story, it is a liquidity event that can pull money across equities, indexes, and crypto."
image_concept: "A rocket on a launchpad reflected in a dark trading floor screen, with scattered index charts glowing below."
